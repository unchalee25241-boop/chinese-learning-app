...
<div style={{ background: palette.gold, color: “#fff”, borderRadius: 999, padding: “6px 14px”, fontSize: 12, fontWeight: 700 }}>👑 อัปเกรด</div>
</div>
);
}
...
{locked.length > 0 && locked.map((_, i) => <LockBadge key={i} onUpgrade={onUpgrade} />)}
</div>
);
}
